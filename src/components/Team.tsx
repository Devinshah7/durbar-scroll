...
export function Team() {
  ...
  return (
    <section id="team" ref={ref} className="relative overflow-hidden py-24 md:py-32" style={{ background: "linear-gradient(180deg, var(--section-cream) 0%, var(--section-terracotta) 20%, var(--section-warm-dark) 100%)" }}>

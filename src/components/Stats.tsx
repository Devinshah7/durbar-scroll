  ...
  return (
    ...
    >
      <div className="mx-auto mb-16 flex max-w-[1100px] items-center px-6 md:px-10">
        <span className="h-px flex-1" style={{ background: "rgba(26,20,16,0.4)" }} />
        <svg viewBox="0 0 80 24" className="mx-3 h-5 w-20" style={{ color: "rgba(26,20,16,0.7)" }}>
          <path
      ...
      <div className="mx-auto mt-20 max-w-[900px] px-6 text-center md:px-10">
        <p
          ...
          style={{ color: "var(--section-dark)", fontSize: "clamp(22px, 2.6vw, 36px)" }}
        >
